...
MODULE_01_STATIONARITY_REPORT_FILENAME = "stationarity_report.csv"
...
M1_MIN_OBSERVATIONS = 10
M1_SKIP_SHORT_SERIES = True
M1_SKIP_CONSTANT_SERIES = True
M1_SKIP_ZERO_VARIANCE_SERIES = True
M1_SKIP_ALL_NAN_SERIES = True
M1_VERBOSE_STATIONARITY = False
